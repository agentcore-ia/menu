...
function HostIconDrumstick() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M14.9 3.6c2.6 0 4.7 2 4.7 4.6 0 2.2-1.5 4-3.6 4.5l-3.7 3.7" />
      <path d="M16.1 12.7c-1.2.2-2.5 0-3.5-.8a4.6 4.6 0 0 1-1.7-3.4" />
      <path d="M12.3 16.4l-2.1 2.1" />
      <path d="M10.2 18.5c.8.8.8 2.1 0 2.9-.8.8-2.1.8-2.9 0-.4.5-1.2.6-1.8.2a1.55 1.55 0 0 1-.2-2.3 1.55 1.55 0 0 1-2.1-.2c-.6-.6-.6-1.6 0-2.2.6-.6 1.6-.6 2.2 0 .1-.8.7-1.4 1.5-1.4 1.1 0 1.8.8 1.8 1.8l1.5 1.2z" />
      <path d="M14.8 6.2c.8.1 1.5.5 1.9 1.2" />
    </svg>
  )
}
