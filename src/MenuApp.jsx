...
function HostIconDrumstick() {
  return (
    <svg className="host-drumstick-icon" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M11.2 15.6c-1.8-.5-2.9-2.2-2.6-4 .1-.7.4-1.3.8-1.9l3.3-4.5c1.3-1.8 3.8-2.2 5.7-.9 2.6 1.7 3.3 5.4 1.4 8-1 1.4-2.4 2.3-4.1 2.7l-4.5.6z" />
      <path d="M10.4 15.1 6.2 19.3" />
      <path d="M6.2 19.3c-.8-.8-2.1-.8-2.9 0s-.8 2.1 0 2.9 2.1.8 2.9 0c.8.8 2.1.8 2.9 0s.8-2.1 0-2.9-2.1-.8-2.9 0z" />
      <path d="M17.6 8.2a3.1 3.1 0 0 1-1.4 2.6" />
    </svg>
  )
}
