...
function HostIconDrumstick() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path
        d="M15.7 3.2c3.1 0 5.4 2.2 5.4 5.2 0 3.3-2.8 5.4-5.8 5.1-.9-.1-1.8-.4-2.5-.9l-4.1 4.1-1.9-1.9 4.1-4.1c-.5-.8-.8-1.6-.9-2.5-.3-3 2.3-5 5.7-5z"
        fill="currentColor"
        stroke="none"
      />
      <path
        d="M8.9 16.8c1 1 1 2.7 0 3.7-.8.8-2 .9-2.9.4-.8.7-2 .6-2.7-.1-.8-.8-.8-2 0-2.8.2-.2.5-.4.8-.5.1-.3.3-.6.5-.9.8-.8 2-.9 2.9-.4l1.4.6z"
        fill="currentColor"
        stroke="none"
      />
      <path d="M14.5 6.1c1.2-.5 2.6-.2 3.4.7" />
    </svg>
  )
}
