...
function HostIconDrumstick() {
  return (
    <svg className="host-drumstick-icon" viewBox="0 0 32 32" aria-hidden="true">
      <path
        d="M21.8 3.7c4.5 0 7.7 3.2 7.7 7.3 0 5.1-4.8 8.4-9.3 7.2-1.1-.3-2.1-.8-3-1.6l-5.7 5.7-2.1-2.1 5.7-5.7c-.8-.9-1.4-1.9-1.6-3-1.2-4.5 2.6-7.8 8.3-7.8z"
        fill="currentColor"
        stroke="none"
      />
      <path
        d="M11.6 21.9c1.5 1.5 1.5 4 0 5.5-1.2 1.2-3.1 1.4-4.5.5-1 .9-2.6.8-3.6-.2-1.1-1.1-1.1-2.9 0-4 .4-.4.9-.7 1.5-.8.1-.6.4-1.1.8-1.5 1.1-1.1 2.8-1.2 4-.3l1.8.8z"
        fill="currentColor"
        stroke="none"
      />
      <path d="M20.4 7.4c1.5-.5 3.1 0 4.1 1.2" />
    </svg>
  )
}
