...
function HostIconDrumstick() {
  return (
    <svg className="host-drumstick-icon" viewBox="0 0 32 32" aria-hidden="true">
      <path
        d="M18.8 4.5c4.9-1.1 9.4 2.5 9.4 7.8 0 4.4-2.5 7.4-6.7 8.8l-4.7 1.6c-1.8.6-3.6.2-4.9-1.1l-1.5-1.5c-1.4-1.4-1.8-3.3-1.1-5.1l1.8-4.6c1.5-3.8 3.8-5 7.7-5.9z"
      />
      <path
        d="M10.8 20.6 7.1 24.3c-1.2-.7-2.8-.4-3.7.7-1 1.2-.9 3 .2 4.1 1.2 1.2 3 1.2 4.2.1 1.1 1.1 3 1.1 4.2-.1 1.1-1.1 1.2-2.9.2-4.1-.7-.8-1.7-1.1-2.7-1l3.9-3.9"
      />
      <path d="M23.7 11.8c-.3 1.6-1.2 2.9-2.6 3.8" />
      <path d="M25.3 9.3h.1" />
    </svg>
  )
}
